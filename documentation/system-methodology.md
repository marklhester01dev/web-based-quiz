...
As a solo project built to apply HTML, CSS, and JavaScript skills learned over time, this approach allows each feature (e.g., category selection, quiz logic, scoring, results) to be fully built and verified before the next is layered on top. This reduces the risk of compounding bugs across untested features, keeps the project usable/demoable at the end of every phase, and makes it easier to track which skills were applied at which stage of development.
