# WEB-BASED QUIZ (Mini-Project)

## About:

This is a web-based quiz mini-project with concepts applied on my previous lessons in JavaScript.
...
assets/
 ...
 js/                                    - interactivity
   |-- components/                      - reusable web components
        ...
        |-- quiz-form-inputs.js         - <quiz-form> custom element for input type quiz
        |-- quiz-form-choices.js        - <quiz-form> custom element for selection type quiz
   |-- enumeration.js                   - enumeration page logic
   |-- identification.js                - identification page logic
   |-- multiple-choice.js               - multiple-choice page logic
   |-- result.js                        - result page logic
   |-- true-false.js                    - true or false page logic
 ...
 pages/                                 - individual quiz category pages
   ...
   |-- true-false.html
tools/
   |-- eslint-setup.md                  - how eslint is used in this project
.gitignore
